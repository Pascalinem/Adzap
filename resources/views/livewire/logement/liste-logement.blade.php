...
<div class="{{$logement->id == $selected_logement_id  ? "bg-green-200" : ""}} w-full mx-4 my-4 sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/4 rounded overflow-hidden shadow-lg">
    <img class="w-full h-60" src="{{ URL::asset('/images/'.$logement->nom.'/living'.$logement->nom.'.jpg') }}" alt="image">
    <div class="px-6 py-4">
...
@else
<p class="text-gray-700 text-base">
  Aucun logement disponible pour la période souhaitée OU ayant une capacité suffisante. 
</p>
@endif
