<x-guest-layout>
    ...
    <form bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 wire:submit.prevent="submit">
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="adresse-etage" placeholder="Entrer l'étage" wire:model="adresse_etage"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="adresse-ville" placeholder="Entrer la ville" wire:model="adresse_ville"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="adresse-code-postal" placeholder="Entrer le code postal" wire:model="adresse_code_postal"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="nombre-chambres" placeholder="Entrer le nombre de chambres" wire:model="nombre_chambres"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="capacite" placeholder="Entrer le nombre de personnes" wire:model="capacite"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" class="form-control" id="superficie" placeholder="Entrer la superficie" wire:model="superficie"></textarea>
